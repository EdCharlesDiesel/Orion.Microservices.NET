...
namespace Orion.API.Production.Controllers
{
    ...
    public class TransactionHistoryArchiveController(IUnitOfWork unitOfWork) : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] TransactionHistoryArchive version)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] DataAccess.Postgres.Entities.TransactionHistoryArchive version)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            try
            {
                ...
                // existing.EmployeeTransactionHistoryArchiveHistories = new List<EmployeeTransactionHistoryArchiveHistory>();
