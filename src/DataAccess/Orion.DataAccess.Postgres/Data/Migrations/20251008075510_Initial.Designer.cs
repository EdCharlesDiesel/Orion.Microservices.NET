...
namespace Orion.DataAccess.Postgres.Data.Migrations
{
    ...
    [Migration("20251008075510_Initial")]
            ...
            modelBuilder.Entity("Orion.DataAccess.Postgres.Entities.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Billing",
                            Rowguid = new Guid("ea71b71c-4e46-4815-9ba4-6ab3eb5d0aef")
                        },
                        new
                        {
                            AddressTypeId = 2,
                            ModifiedDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Home",
                            Rowguid = new Guid("3fb98e4f-6e9b-4709-9f83-167a2022261d")
                        },
                        new
                        {
                            AddressTypeId = 3,
                            ModifiedDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Main Office",
                            Rowguid = new Guid("a5cecf60-7dea-4f44-87ed-54d8f7ce1c38")
                        },
                        new
                        {
                            AddressTypeId = 4,
                            ModifiedDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Primary",
                            Rowguid = new Guid("20e92d96-73cf-4c51-825e-b6d77c90601a")
                        },
                        new
                        {
                            AddressTypeId = 5,
                            ModifiedDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Shipping",
                            Rowguid = new Guid("ba7c5704-e938-4694-85a9-99534cb1d4c2")
                        },
                        new
                        {
                            AddressTypeId = 6,
                            ModifiedDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Archive",
                            Rowguid = new Guid("b12f97d1-aa1f-4043-ac86-1b83525b0228")
                        });
                });
            ...
            modelBuilder.Entity("Orion.DataAccess.Postgres.Entities.BusinessEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BusinessEntityID = 1,
                            ModifiedDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Rowguid = new Guid("679ee679-e0aa-4469-aa42-b993b47bcf75")
                        });
                });
            ...
            modelBuilder.Entity("Orion.DataAccess.Postgres.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Rowguid = new Guid("956ce7f1-c0b5-41b6-9cf1-150966904c9c"),
                            Salary = 5000,
