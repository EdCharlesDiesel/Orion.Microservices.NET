    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(OrionDbContext context)
        {
            ...
            ProductVendors = new ProductVendorsRepository(_context); 
             ...
             InternalEmployees = new InternalEmployeesRepository(_context); 
             ExternalEmployees = new ExternalEmployeesRepository(_context); 
        ...
        public IInternalEmployeesRepository InternalEmployees { get; set; }
        public IExternalEmployeesRepository ExternalEmployees { get; set; }
